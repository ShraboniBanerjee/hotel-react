...
<Card style={{borderRadius:'10px',marginTop:'2%'}}>
      ...
      <Nav variant="pills">
          <Nav.Item>
  <Nav.Link href="/arrivalPage" style={{fontFamily:"inter"}} > Arrival
      </Nav.Link> 

          </Nav.Item> 
          <Nav.Item>
            <Nav.Link href="/departurePage" style={{fontFamily:"inter",color:'#000000', backgroundColor:'#EDEFF5'}}>Departures</Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link href="/stayOver" style={{fontFamily:"inter",color:'#000000', backgroundColor:'#EDEFF5'}}>
              Stay-Overs
            </Nav.Link>
          </Nav.Item>
        </Nav>
