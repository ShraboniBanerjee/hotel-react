...
class DeparturePage extends React.Component {
    constructor(props){
        super(props);
...
<Card style={{borderRadius:'10px', marginTop:'2%'}}>
      ...
      <Nav variant="pills" defaultActiveKey="/departurePage">
          <Nav.Item>
             ...
             {['checkbox'].map((type) => (
               <div key={`reverse-${type}`} className="mb-3">
                 ...
                 <Form.Check
                   ...
                   id={`disabled-${type}`}
                 />
                <Link to={"/bookingDetails"}><button style={{float:"right", color:"white", backgroundColor:"#0066FF", border:'none', fontStyle:'normal', fontColor:'#ffffff', fontWeight:'400', fontSize:'16px', borderRadius:'5px', marginTop:'4%'}}>Continue </button></Link>          
...
export default adminLayout(DeparturePage);